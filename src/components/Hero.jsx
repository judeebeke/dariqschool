  ...
  return (
    <div className='py-14 px-12 w-[100vw]'>
        <section className='w-full flex items-center flex-col lg:flex-row '>
          ...
          <h1 className='text-3xl md:text-5xl font-extrabold text-black'>Come Join Us And Achieve Your Dreams Here In <span className="text-primary">Dariq</span> School</h1>
          <p className="text-black text-sm font-semibold text-justify">Our Curriculum is designed to ignite curiosity, foster creativity and prepare students for a dynamic world where knowledge of both traditional academics and modern technology is key.</p>
          <button className="btn border-none bg-primary p-3 mt-5 text-white rounded-xl max-w-40 h-auto text-base font-semi-bold hover:bg-secondary transition-all ease-in-out duration-500">Learn More</button>
