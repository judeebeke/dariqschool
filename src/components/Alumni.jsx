...
const Alumni = () => {
  return (
    ...
    <button className="btn border-none w-40 btn-primary p-3 mt-14 text-white rounded-xl h-auto text-base font-semi-bold outline-1 outline-secondary hover:bg-secondary transition-all ease-in-out duration-500">Get Started</button>
    </div>
